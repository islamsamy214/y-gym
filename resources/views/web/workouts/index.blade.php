...
<div class="container">
    <div class="row control-bar">
        <div class="col-md-4 search-bar" >
            <form method="GET" action="{{ route('web.workouts') }}">
...
@if ($workouts->count() > 0)
    ...
    <div class="table-responsive">
        <table class="table text-center">
          ...
          <tbody>
            ...
            <tr class="cursor-pointer" data-toggle="modal" data-target="#modal-{{ $workout->id }}">
                ...
                <td><img src="{{ $workout->image ? $workout->image_path : '' }}" class="img-thumbnail workout-image" /></td>
                <td>{{ $workout->name }}</td>
        ...
        <div class="col-sm-12 container text-center workouts-web-paginator">
